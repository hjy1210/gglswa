...
4. °Ñ¦Ò [Set up local development for Azure Static Web Apps](https://docs.microsoft.com/en-us/azure/static-web-apps/local-development)¡AAt root directory of solution, execute `swa start http://localhost:5000`
